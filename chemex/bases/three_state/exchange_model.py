...
def update_params(params=None,
    ...
    if model == '3st.pb_kex':
        ...
        params.add_many(  # Name, Value, Vary, Min, Max, Expr
            ...
            (map_names['dH_AC'], 0.0, True, None, None, None),
            (map_names['dH_TSAB'], 10.0, True, 0.0, None, None),
            (map_names['dH_TSBC'], 10.0, True, 0.0, None, None),
            (map_names['dH_TSAC'], 10.0, False, 0.0, None, None),
